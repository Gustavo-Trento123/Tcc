...
<?php 
    ...
    <div class="container-noticia">
        ...
        <ul class="pagination">
            <li class="waves-effect"><a href="noticia.php"><i class="material-icons">chevron_left</i></a></li>
            <li class="waves-effect"><a href="noticia.php">1</a></li>
            <li class="active"><a href="noticia-2.php">2</a></li>
