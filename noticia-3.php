...
<?php 
    ...
    <div class="container-noticia">
        ...
        <ul class="pagination">
            <li class="waves-effect"><a href="noticia-2.php"><i class="material-icons">chevron_left</i></a></li>
            <li class="waves-effect"><a href="noticia-2.php">1</a></li>
            <li class="waves-effect"><a href="noticia-2.php">2</a></li>
            <li class="active"><a href="noticia-3.php">3</a></li>
            <li class="waves-effect"><a href="noticia-3.php"><i class="material-icons">chevron_right</i></a></li>
        </ul>   
    </div>
