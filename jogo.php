    ...
    <div id="navegacao" class="nav-extended nav-wrapper">
                ...
                <li>
                    ...
                    <ul id='dropdown2' class='dropdown-content-sidnav' style="position: relative;">
                        <fieldset class="dropdown-jogos">
                            ...
                            <li><a href="#!">Top de Todos os Tempos</a></li>
                        ...
                        <fieldset class="dropdown-jogos">
                            ...
                            <li><a>Aventura</a></li>
                            <li><a>Terror</a></li>
                            <li><a>Estratégia</a></li>
                            <li><a>RPG</a></li>
                        </fieldset>
                        <fieldset class="dropdown-jogos">
                            <legend>Fique por Dentro</legend>
                            <li><a>Novidades</a></li>
                            <li><a>The Game Awards</a></li>
                        </fieldset>
                    </ul>
                </li>
                <li><a href="#">Críticos</a></li>
        ...
        <div id="modal1" class="modal">
            <div class="modal-content center-align">
                <div id="titulo">    
                    <img class="logo-modal" src="assets/img/logo.png"><h4>The Real Score</h4>
                </div>
                <div id="logins">
...
>>>>>>> Stashed changes:jogo.php
        ...
        <div id="info-jogo">
            <img src="assets/img/carrosel/carrosel3.jpg " id="imagem-jogo" class="responsive-table">
            <h5>Starfield</h5>
        </div>
